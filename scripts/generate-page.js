...
if (!componentName) {
    ...
    console.log('   Пример: npm run generate:page home');
    process.exit(1);
}
...
const basePath = path.join(__dirname, '..', 'src', 'pages', componentFileName);

const folders = [basePath, path.join(basePath, 'ui')];
...
console.log(`src/pages/${componentFileName}/`);
console.log(`├── ui/`);
